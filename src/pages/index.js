      ...
      <div className="section section--banner">
        <div className="section__inner">
          ...
          <div className="section__half section__half--right">
            <img className="image--desktop" src="/assets/images/banner-phones.svg" alt="Airvat Phone Demo" />
            <img className="image--mobile" src="/assets/images/banner-phones-mobile.png" alt="Airvat Phone Demo" />
          </div>
        </div>
      </div>
      <div className="section section--introduction">
        <div className="section__inner">
          <div className="section__half introduction--left">
            <img className="image--desktop" src="/assets/images/CTA-image.png" alt="Easy to use" />
            <img className="image--mobile" src="/assets/images/introduction-mobile.png" alt="Easy to use" />
          </div>
          <div className="section__half introduction--right">
            <div className="introduction__content">
              ...
              <div className="introduction__point">
                <img src="/assets/images/tax-icon-mobile.png" alt="Tax" className="mobile-icon" />
              ...
              <div className="introduction__point">
                <img src="/assets/images/shop-icon-mobile.png" alt="Tax" className="mobile-icon" />
              ...
              <div className="introduction__point">
                <img src="/assets/images/paperwork-icon-mobile.png" alt="Tax" className="mobile-icon" />
      ...
      <div className="section section--features">
        <div className="section__inner">
          ...
          <div className="section__half features--right">
            <img className="active" src="/assets/images/phone-receipts.png" alt="Upload Receipts" data-feature="receipts" />
